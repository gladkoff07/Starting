...
// Remove html before build
gulp.task('pug:build', gulp.series('html-del', () => {
  return gulp.src(config.pug.src)
    .pipe(plumber())
...
/* Dev */
gulp.task('watch', gulp.parallel('browser-sync', 'pug:dev', 'styles:dev', 'img', 'fonts', 'svg', 'scripts:dev', 'script-libs', () => {
...
/* Build */
gulp.task('build', gulp.parallel('styles:build', 'pug:build', 'fonts', 'svg', 'scripts:build', 'script-libs',  () => {
